...
// Registered at describe scope (not inside a test) so it also covers the before/after
// hooks: on 4.5.0 the admin console's module loader throws this during admin login.
